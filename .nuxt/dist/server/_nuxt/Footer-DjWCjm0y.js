import { inject, getCurrentInstance, onUnmounted, computed, ref, reactive, onActivated, provide, unref, isVNode, watch, defineComponent, createVNode, watchEffect, mergeProps, Transition, Teleport, withDirectives, vShow, nextTick, Fragment, withKeys, toRaw, isRef, withCtx, useSSRContext } from "vue";
import { c as navigateTo, b as useRuntimeConfig, _ as _export_sfc, f as useRoute$2, u as useRouter$1 } from "../server.mjs";
import { ssrRenderStyle, ssrRenderAttr, ssrRenderClass, ssrRenderComponent } from "vue/server-renderer";
...
$fetch.create({
  ...
  onResponseError({ response }) {
    return Promise.reject((response == null ? void 0 : response._data) ?? null);
  }
});
function commonFun() {
  useRouter();
...
//# sourceMappingURL=Footer-DjWCjm0y.js.map
