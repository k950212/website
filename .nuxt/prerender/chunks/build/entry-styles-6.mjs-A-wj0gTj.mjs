import { ref, onUpdated, provide, watch, nextTick as nextTick$1, h, computed } from 'file:///Users/yunhao/Project/website/node_modules/.pnpm/vue@3.5.11_typescript@5.4.4/node_modules/vue/index.mjs';
...
function updateSwiper(_ref) {
  ...
  if (needPaginationInit) {
    if (swiper2.isElement && (!paginationEl || typeof paginationEl === "string")) {
      paginationEl = (void 0).createElement("div");
  ...
  if (needScrollbarInit) {
    if (swiper2.isElement && (!scrollbarEl || typeof scrollbarEl === "string")) {
      scrollbarEl = (void 0).createElement("div");
  ...
  if (needNavigationInit) {
    if (swiper2.isElement) {
      if (!nextEl || typeof nextEl === "string") {
        nextEl = (void 0).createElement("div");
      ...
      if (!prevEl || typeof prevEl === "string") {
        prevEl = (void 0).createElement("div");
...
export { Autoplay as A, Navigation as N, Pagination as P, Swiper2 as S, SwiperSlide as a, navigation as n, pagination as p, swiper as s };
//# sourceMappingURL=entry-styles-6.mjs-A-wj0gTj.mjs.map
